 ...
 *   node digest.mjs out/wegic.json out/openhero.json      # side-by-side
 *   node digest.mjs out/wegic.json --format md > report.md
 *   node digest.mjs out/wegic.json --section coverage     # anatomy | coverage | all
 *   node digest.mjs out/wegic.json --strict-mobile        # count a source with no
