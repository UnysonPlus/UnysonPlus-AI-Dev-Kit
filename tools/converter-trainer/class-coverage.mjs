 ...
 *   node class-coverage.mjs --corpus openhero  only sites whose capture URL matches this substring
...
const renderedPath = slug => { const n=join(BATCH,slug,'openhero_art_api_preview','rendered.html'), f=join(BATCH,slug,'rendered.html'); return existsSync(n)?n:(existsSync(f)?f:null); };
function siteList(){
